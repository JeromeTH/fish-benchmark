...
if __name__ == '__main__':
    ...
    transform = lambda video: image_processor(list(video), return_tensors="pt").pixel_values.squeeze(0) #squeeze the batch dimension
    ...
    print("Loading model...")
    model = VideoMAEModel.load_from_checkpoint("video_mae_model.ckpt", num_classes=len(classes))
    print("Model loaded.")
